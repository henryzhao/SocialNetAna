...
public final class FileUtil
{
    ...
    public static String read(final String filePath, final Integer spec)
    {
        ...
        try
        {
            ...
            {
                sb.append(str + "\n");
                //jieStrings=str.split(",");
               // System.out.println(jieStrings[2]);
     ...
     * @since 2016-3-1
     */
    public static int write(final String filePath, final double[][] content, final boolean append)
    {
        File file = new File(filePath);
        if (content == null)
        {
        ...
        for (int i = 0; i < content.length; i++) {
			for (int j = 0; j < content[0].length; j++) {
				contentString.append(content[i][j]);
				contentString.append("/t");
			}
			contentString.append("/n");
		}
        ...
        try
        {
            ...
            bw.write(contentString.toString());
        }
        catch (IOException e)
        {
            e.printStackTrace();
